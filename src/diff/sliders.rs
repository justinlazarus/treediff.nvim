...
/// delimiter?
fn prefer_outer_delimiter(language: language::Language) -> bool {
...
mod tests {
    ...
    fn test_slider_at_start() {
        ...
        fix_all_sliders(language::Language::EmacsLisp, &lhs, &mut change_map);
    ...
    fn test_slider_two_steps() {
        let arena = Arena::new();
        let config = from_language(language::Language::EmacsLisp);
        ...
        fix_all_sliders(language::Language::EmacsLisp, &rhs, &mut change_map);
